 ...
 *
 * 表结构: favicons - domain (keyPath): 站点 origin，如 "https://github.com" - name: 站点名称 - favicon: base64 dataURL 格式的图标（图片本身） - favIconUrl: favicon 原始 URL（图片来源地址） - url: 书签地址 - updatedAt: 更新时间戳
 */
