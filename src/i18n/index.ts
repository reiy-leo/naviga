...
const resources = {
  zh: {
    translation: {
      ...
      create: '创建',
      createShadow: '创建影子...',
      createShadowToWorkspace: '在工作区创建影子...',
      customize: '个性化',
      dark: '深色',
      data: '数据',
      deep: '深邃',
      ...
      deleteShadowFolder: '删除影子文件夹',
      deleteShadowFolderHint: '只删除影子本身，不影响源文件夹',
      sync_chrome: '同步浏览器',
      ...
      settings: '设置',
      shadows: '影子书签/文件夹',
      shadowStyle: '影子书签/文件夹样式',
      shadowFolder: '创建影子文件夹到...',
      shadowFolderHint:
        '影子文件夹用于在别处展示本文件夹，对本文件夹的任何修改会同步给所有影子，对影子文件夹的修改也会同步给所有关联影子和源文件夹',
      showTabBar: '显示标签栏',
      workspaces_general: '常规',
      workspaces_colors: '名称、图标',
      small: '小',
      smartView: '智能视图',
      subBookmarks: '子书签',
      subtle: '淡雅',
  ...
  ja: {
    translation: {
      ...
      name: '名前',
      navbar_icon_size: 'ナビゲーショナルベルサイズ',
      nbi_base: '中',
      nbi_lg: '大',
      nbi_sm: '小',
